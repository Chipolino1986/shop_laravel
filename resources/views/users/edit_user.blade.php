        ...
        <div class="container-fluid">
            ...
            <div class="row">
                <form action="{{route('user.update', $user->id)}}" method="post">
                    ...
                    <div class="form-group">
                        <input type="text" value="{{$user->telephone ?? old('telephone')}}" name="telephone" class="form-control" placeholder="Телефон">
                    </div>
                    <div class="form-group">
                        <select name="gender" class="custom-select form-control" id="exampleSelectBorder">
                            <option disabled selected>Пол</option>
                            <option {{ $user->gender == 1 || old('gender') == 1 ? ' selected' : ''}} >Мужской</option>
                            <option {{ $user->gender == 2 || old('gender') == 2 ? ' selected' : ''}} >Женский</option>
                        </select>
                    </div>
                    <div class="form-group">
